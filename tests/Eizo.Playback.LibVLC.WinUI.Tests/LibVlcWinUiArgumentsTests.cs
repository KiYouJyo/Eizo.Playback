...
namespace Eizo.Playback.LibVLC.WinUI.Tests;

public sealed class LibVlcWinUiArgumentsTests
{
    [Fact]
    public void ComposePreservesNormalUserArguments()
    {
        ...
        var result = LibVlcWinUiArguments.Compose(
            source,
            [
    ...
    public void ComposeRejectsMissingSurfaceArguments()
    {
        ...
        Assert.Throws<ArgumentException>(
            () => LibVlcWinUiArguments.Compose(source, []));
    }
}
